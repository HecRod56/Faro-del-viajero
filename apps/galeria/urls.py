...
urlpatterns = [
    path("viaje/<int:id_viaje>/galeria/",          views.ver_galeria,     name="ver_galeria"),
    path("viaje/<int:id_viaje>/galeria/subir/",    views.subir_imagen,    name="subir_imagen"),
    path("galeria/imagen/<int:id_imagen>/eliminar/", views.eliminar_imagen, name="eliminar_imagen"),
