#urls.py gestion_viajes
from django.urls import path
from . import views

app_name = 'gestion_viajes'
...
urlpatterns = [
    ...
    path('eliminar-ajax/<int:viaje_id>/', views.eliminar_viaje_ajax, name='p_eliminar_viaje_ajax'),
    path('restaurar-ajax/', views.restaurar_viaje_ajax, name='p_restaurar_viaje_ajax'),
    ...
    path('gasto/<int:gasto_id>/eliminar-ajax/', views.eliminar_gasto_ajax, name='p_eliminar_gasto_ajax'),
    path('gasto/restaurar-ajax/', views.restaurar_gasto_ajax, name='p_restaurar_gasto_ajax'),
